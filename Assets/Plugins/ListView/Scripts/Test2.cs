...
public class Test2 : MonoBehaviour
{
    ...
    void OnBtn()
    {
        ...
        _testListView.DataSource = datas;
        _testListView.ScrollTo(11);
    }
    private void Awake()
    {
        _testListView.OnClickItem = OnClickItemCB;
    ...
    void SetData(GameObject item, int index)
    {
    }
